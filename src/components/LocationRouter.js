    ...
    return (
      <Switch>
        ...
        <Route path={`${match.url}/checkin/:preCheckId?`}>
          <Checkin storeId={storeIdParam} setLoaderStatus={setLoaderStatus} setOverlayModal={setOverlayModal} setCheckedIn={setCheckedIn} />
        </Route>
        <Route path={`${match.url}/success/:customerId?`}>
          <Success storeId={storeIdParam} setLoaderStatus={setLoaderStatus} setOverlayModal={setOverlayModal} checkedIn={checkedIn} setCheckedIn={setCheckedIn} />
        </Route>
